...
clean:
	rm -f *.gch Wander.o KinematicSeek.o KinematicArrive.o Align.o VelocityMatch.o Flee.o Face.o Separation.o main.o Player.o Triple.o parse.o util.o Ent.o Phantom.o LookWhereYoureGoing.o gl.o KinematicFlee.o game.o Seek.o Actor.o Arrive.o KinematicWander.o RuntimePekomin.o Evade.o Pursue.o pekomin

pekomin: Wander.o KinematicSeek.o KinematicArrive.o Align.o VelocityMatch.o Flee.o Face.o Separation.o main.o Player.o Triple.o parse.o util.o Ent.o Phantom.o LookWhereYoureGoing.o gl.o KinematicFlee.o game.o Seek.o Actor.o Arrive.o KinematicWander.o RuntimePekomin.o Evade.o Pursue.o
	$(CXX) $(CXXOPTS) -o pekomin Wander.o KinematicSeek.o KinematicArrive.o Align.o VelocityMatch.o Flee.o Face.o Separation.o main.o Player.o Triple.o parse.o util.o Ent.o Phantom.o LookWhereYoureGoing.o gl.o KinematicFlee.o game.o Seek.o Actor.o Arrive.o KinematicWander.o RuntimePekomin.o Evade.o Pursue.o $(LDLIBS)
...
parse.o: parse.cpp Behaviors.hpp game.hpp Mobile.hpp parse.hpp Player.hpp RuntimePekomin.hpp Align.hpp Arrive.hpp Evade.hpp Face.hpp Flee.hpp KinematicArrive.hpp KinematicFlee.hpp KinematicSeek.hpp KinematicWander.hpp LookWhereYoureGoing.hpp Pursue.hpp Seek.hpp Separation.hpp VelocityMatch.hpp Wander.hpp Ent.hpp Actor.hpp Kinematic.hpp DirectKinematic.hpp Triple.hpp Behavior.hpp Families.hpp DirectStatic.hpp Static.hpp Dynamic.hpp
...
Actor.o: Actor.cpp Actor.hpp Mobile.hpp Behavior.hpp Families.hpp Ent.hpp DirectStatic.hpp Static.hpp DirectKinematic.hpp Kinematic.hpp Dynamic.hpp Triple.hpp
	$(CXX) $(CXXOPTS) -c Actor.cpp

Arrive.o: Arrive.cpp Arrive.hpp Mobile.hpp DirectKinematic.hpp Ent.hpp Behavior.hpp Triple.hpp

...
clean:
	rm -f *.gch Wander.o KinematicSeek.o KinematicArrive.o Static.o Align.o VelocityMatch.o Kinematic.o Flee.o Face.o Separation.o main.o Player.o Triple.o util.o Ent.o LookWhereYoureGoing.o Direct.o gl.o KinematicFlee.o Seek.o Actor.o Arrive.o Dynamic.o KinematicWander.o RuntimePekomin.o Evade.o Pursue.o pekomin

pekomin: Wander.o KinematicSeek.o KinematicArrive.o Static.o Align.o VelocityMatch.o Kinematic.o Flee.o Face.o Separation.o main.o Player.o Triple.o util.o Ent.o LookWhereYoureGoing.o Direct.o gl.o KinematicFlee.o Seek.o Actor.o Arrive.o Dynamic.o KinematicWander.o RuntimePekomin.o Evade.o Pursue.o
	$(CXX) $(CXXOPTS) -o pekomin Wander.o KinematicSeek.o KinematicArrive.o Static.o Align.o VelocityMatch.o Kinematic.o Flee.o Face.o Separation.o main.o Player.o Triple.o util.o Ent.o LookWhereYoureGoing.o Direct.o gl.o KinematicFlee.o Seek.o Actor.o Arrive.o Dynamic.o KinematicWander.o RuntimePekomin.o Evade.o Pursue.o $(LDLIBS)
...
main.o: main.cpp game.hpp gl.hpp Behaviors.hpp RuntimePekomin.hpp Player.hpp Align.hpp Arrive.hpp Evade.hpp Face.hpp Flee.hpp Kinematic.hpp KinematicArrive.hpp KinematicFlee.hpp KinematicSeek.hpp KinematicWander.hpp LookWhereYoureGoing.hpp Pursue.hpp Seek.hpp Separation.hpp Triple.hpp VelocityMatch.hpp Wander.hpp Actor.hpp Mobile.hpp Behavior.hpp Families.hpp Ent.hpp Direct.hpp Static.hpp Dynamic.hpp
	$(CXX) $(CXXOPTS) -c main.cpp

Player.o: Player.cpp Player.hpp gl.hpp Mobile.hpp Ent.hpp Triple.hpp
...
Actor.o: Actor.cpp Actor.hpp Mobile.hpp Behavior.hpp Families.hpp Ent.hpp Triple.hpp Direct.hpp Static.hpp Kinematic.hpp Dynamic.hpp
...
RuntimePekomin.o: RuntimePekomin.cpp RuntimePekomin.hpp gl.hpp Actor.hpp Mobile.hpp Behavior.hpp Families.hpp Ent.hpp Triple.hpp Direct.hpp Static.hpp Kinematic.hpp Dynamic.hpp
